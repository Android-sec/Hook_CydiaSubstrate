...
// MSConfig(MSFilterExecutable, "/system/lib/libdvm.so")
...
MSInitialize {
	...
	__android_log_print(ANDROID_LOG_ERROR,"native_hook_MSInitialize","shell/SuperApplication-4");

	// com.tencent.mm.app.MMApplication 是微信的application的类名
	MSJavaHookClassLoad(NULL, "android/taobao/atlas/startup/AtlasBridgeApplication", &OnClazzLoad);
