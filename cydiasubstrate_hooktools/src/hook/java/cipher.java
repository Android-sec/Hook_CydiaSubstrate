...
public class cipher implements MS.ClassLoadHook
{
	...
	{
		MS.hookClassLoad("javax.crypto.Cipher", cipher.getInstance());
	}
		...
		if ( init != null )
		{
			...
			MS.hookMethod( clazz, init, new MS.MethodHook( )
			{
				...
				public Object invoked( Object arg0, Object... arg1 ) throws Throwable
				{
					...
					Log.i( "hook_Cipher_doFinal_key", Arrays.toString(key) );
					Log.i( "hook_Cipher_doFinal_iv", Arrays.toString(iv) );
		...
		if(doFinal != null){
			...
			MS.hookMethod( clazz, doFinal, new MS.MethodHook( )
			{
				...
				public Object invoked( Object arg0, Object... arg1 ) throws Throwable
				{
					...
					Log.i( "hook_Cipher_doFinal_data", Arrays.toString((byte[])arg1[0]) );
					Log.i( "hook_Cipher_doFinal_result", Arrays.toString(result) );
					statckTrace.LogStatckTrace("hook_Cipher_StatckTrace");
					return result;
				}
			}, doFinalold );
